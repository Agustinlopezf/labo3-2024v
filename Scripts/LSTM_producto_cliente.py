...
bucket_datasets= '~/buckets/b1/datasets'
bucket_exp= '~/buckets/b1/datasets'

#Carga archivos
sell_in = pd.read_csv(os.path.join(bucket_datasets, 'sell-in.txt'), delimiter = '\t')
tb_productos = pd.read_csv(os.path.join(bucket_datasets, 'tb_productos_descripcion.txt'), delimiter = '\t')
tb_stocks = pd.read_csv(os.path.join(bucket_datasets, 'tb_stocks.txt'), delimiter = '\t')
productos_predecir = pd.read_csv(os.path.join(bucket_datasets, 'productos_a_predecir.txt'), delimiter = '\t') 
...
resultados_kaggle_LSTM.to_csv(os.path.join(bucket_exp, 'predicciones_LSTM_droput.csv'), index= False)